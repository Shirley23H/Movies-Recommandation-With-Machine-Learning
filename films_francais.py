...
# Load the datasets
df_fr = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\df_fr_290501.csv")
df_fr_actor = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\df_fr_actors.csv")
tmdb_df_1 = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\tmdb_df_1.csv")
df_fr_genres = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\df_fr_genres.csv")
