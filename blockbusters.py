...
# Load the datasets
df_bl = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\df_bl_final_290501.csv")
df_bl_actor = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\df_bl_actors.csv")
tmdb_df_1 = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\tmdb_df_1.csv")
df_bl_genres = pd.read_csv(r"C:\Users\maxim\OneDrive\Bureau\WCS_DATA\P2\VS_code_P2\datasets\df_bl_genres_1.csv")
